...
// CREADO BORRAR SI TODO SE ROMPE
// ##################################################################
void DemoLinkedList()
{
    LinkedList<LLTraitAsc<int, int>> listaEnlazadaAsc;
    LinkedList<LLTraitAsc<int, int>> listaLeida;
    LinkedList<LLTraitDesc<int, int>> listaEnlazadaDes;

    listaEnlazadaAsc.insert(10,1);
    listaEnlazadaAsc.insert(20,2);
    ...
    if (myfile.is_open()) 
    {
        myfile << listaEnlazadaAsc << endl;
        myfile.close();
    }

    ifstream toread("test.txt");
    toread >> listaLeida;
    cout << "Se crea otro objeto de lista enlazada llamado 'ListaLeida'  y se muestra su contenido" << endl;
    cout << listaLeida << endl;
    toread.close();

    cout << "Se crea una lista enlazada descendentemente:" << endl;
    cout << "Se imprime la lista en el formato { value  linkedvalue }" << endl;
    listaEnlazadaDes.insert(1,10);
    listaEnlazadaDes.insert(2,20);
    listaEnlazadaDes.insert(3,30);
    listaEnlazadaDes.insert(4,40);
    listaEnlazadaDes.insert(5,50);
