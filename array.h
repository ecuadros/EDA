...
public:
    ...
    //==========================================================================================
    //Se agrega last() para obtener el puntero al último elemento del contenedor.
    //A diferencia de end() que devolvía el puntero siguiente al último elemento.
    iterator last()  { iterator iter(this, m_pVect+ (m_vcount - 1)); return iter;}
    //==========================================================================================
};
